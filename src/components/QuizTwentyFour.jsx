...
import img241 from '../pictures/24_1.png';
import img242 from '../pictures/24_2.png';
import img243 from '../pictures/24_3.png';
import data from '../bd.json';
import { useState } from 'react';
import { useNavigate, useLocation } from "react-router-dom"

const QuizTwentyFour = () => {
...
function img(){
  if(key===64){
    return <img className="imgs2425" src={img241} alt="Doctor"/>
  } else if(key===65){
     return<img className="imgs2425" src={img242} alt="Doctor"/>
  } else if(key===66){
    return<img className="imgs2425" src={img243} alt="Doctor"/>
  }
}
