...
import img251 from '../pictures/25_1.png';
import img252 from '../pictures/25_2.png';
import img253 from '../pictures/25_3.png';
import data from '../bd.json';
import { useState } from 'react';
import { useNavigate, useLocation } from "react-router-dom"

const QuizTwentyFive = () => {
...
function img(){
  if(key===68){
    return <img className="imgs2425" src={img251} alt="Doctor"/>
  } else if(key===69){
     return<img className="imgs2425" src={img252} alt="Doctor"/>
  } else if(key===70){
    return<img className="imgs2425" src={img253} alt="Doctor"/>
  }
}
